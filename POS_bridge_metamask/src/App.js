...
const App = () => {
  ...
  const transferERC20 = async () => {
    ...
    // await maticPoSClient.transferERC20Tokens(config.posChildERC20, account,x1, {
    //   from: account,
    //   // parent: true
    // })

    const erc20Token = maticPoSClient.erc20Token();
    config.log("erc20Token",erc20Token)
    // await maticPoSClient
    //   .transferERC20Tokens(config.posChildERC20, x1, {
    //     from: account,
    //   })
    //   .then((res) => {
    //     setBurnHash(res.transactionHash);
